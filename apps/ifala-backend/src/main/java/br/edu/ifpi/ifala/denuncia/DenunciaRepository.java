...
public interface DenunciaRepository extends JpaRepository<Denuncia, Long>, JpaSpecificationExecutor<Denuncia> {
  ...
  /*
   * Os métodos de busca avançada são herdados de JpaSpecificationExecutor
   * e gerados automaticamente pelo Spring Data JPA com base nas especificações
   * fornecidas no service.
   */
}
