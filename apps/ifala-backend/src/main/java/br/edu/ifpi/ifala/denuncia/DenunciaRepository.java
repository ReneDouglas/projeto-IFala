...
/**
 * Classe repositório para gerenciamento de entidades Denuncia. Responsável por operações de
...
public interface DenunciaRepository
  ...
  /*
   * Os métodos de busca avançada são herdados de JpaSpecificationExecutor e gerados automaticamente
