...
/**
 * Data Transfer Object (DTO) para representar os dados de identificação
 * do denunciante em uma denúncia.
 * 
...
public record DadosDeIdentificacaoDto(
    @NotBlank(message = "O nome não pode ser vazio.") @Size(max = 255, message = "O nome completo não pode exceder 255 caracteres.") String nomeCompleto,

    @NotBlank(message = "O email não pode ser vazio.") @Email(message = "Formato de email inválido.") @Size(max = 255, message = "O email não pode exceder 255 caracteres.") String email,
