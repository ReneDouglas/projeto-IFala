    ...
    http.csrf(AbstractHttpConfigurer::disable)
        ...
        .authorizeHttpRequests(auth -> auth
            .requestMatchers("/api/v1/auth/login", "/actuator/**",
                "/api/v1/auth/redefinir-senha/**", "/api/v1/auth/validar-token-redefinicao",
                "/api/v1/public/**", "/api/v1/auth/refresh", "/api/v1/utils/**", "/swagger-ui/**",
                "/v3/api-docs/**", "/swagger-ui.html", "/webjars/**", "/swagger-resources/**")
            .permitAll()
