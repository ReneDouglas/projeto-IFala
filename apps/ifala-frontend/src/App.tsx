  ...
  return (
    <div className="app">
        ...
        <div className="container">
          <div className="hero-content">
            ...
            <p className="hero-subtitle">
              Sua identidade está protegida. Relate ocorrências com total privacidade e acompanhamento seguro.
            </p>
          </div>
        </div>
      </section>
          ...
          <section className="action-section">
            ...
            <div className="action-buttons">
              <div className="action-card">
                <div className="action-card-icon"><span className="material-symbols-outlined">shield</span></div>
                <h3>Fazer uma Denúncia</h3>
                <p>Relate ocorrências de forma completamente anônima e segura</p>
              ...
              <div className="action-card">
                <div className="action-card-icon"><span className="material-symbols-outlined">search</span></div>
                <h3>Acompanhar Denúncia</h3>
                <p>Use seu token para verificar o status da sua denúncia</p>
                <button className="btn-secondary" onClick={handleAcompanharClick}>
                  Acompanhar Denúncia
                </button>
          ...
          <section className="description-section">
            <div className="container">
              ...
              <div className="institutional-logos">
                <img src={ifalaLogo} alt="Logo IFala" className="institutional-logo" />
                <img src={ifpiLogo} alt="Logo IFPI" className="institutional-logo" />
              </div>
              <h2 className="description-title">Sistema Oficial do IFPI - Campus Corrente</h2>
              <p className="description-text">
                O IFala é o sistema oficial do Instituto Federal do Piauí - Campus Corrente para dar voz aos estudantes de forma anônima e segura. Relate ocorrências que acontecem dentro da instituição com total privacidade e acompanhamento protegido.
              </p>
              <div className="exclusive-notice">
                <p>
                  <strong>Exclusivo para estudantes:</strong> Este canal é destinado apenas aos estudantes regularmente matriculados no Instituto Federal do Piauí - Campus Corrente.
                </p>
              </div>
            </div>
          </section>
        ...
        <div className="container">
          ...
          <div className="security-features">
            <div className="security-feature">
              <div className="security-feature-icon"><span className="material-symbols-outlined">lock</span></div>
              <h3>Anonimato Total</h3>
              <p>Sua identidade nunca será revelada. Sistema 100% anônimo.</p>
            </div>
            <div className="security-feature">
              <div className="security-feature-icon"><span className="material-symbols-outlined">block</span></div>
              <h3>Nenhum Dado Pessoal</h3>
              <p>Não coletamos nem armazenamos informações pessoais.</p>
            </div>
            <div className="security-feature">
              <div className="security-feature-icon"><span className="material-symbols-outlined">encrypted</span></div>
              <h3>Comunicação Criptografada</h3>
              <p>Todas as informações são protegidas por criptografia avançada.</p>
            </div>
            <div className="security-feature">
              <div className="security-feature-icon"><span className="material-symbols-outlined">smartphone</span></div>
              <h3>Acompanhamento Seguro</h3>
              <p>Use seu token para acompanhar o progresso de forma protegida.</p>
            </div>
          </div>
          ...
          <div className="warning-section">
            <div className="warning-card">
              <h3 className="warning-title">
                <span className="material-symbols-outlined">warning</span> Aviso Importante
              </h3>
              <p className="warning-text">
                Este canal é destinado a denúncias sérias e legítimas. O uso inadequado, incluindo trotes ou falsas denúncias, pode constituir crime conforme a legislação brasileira (Art. 340 do Código Penal - Comunicação falsa de crime).
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="footer">
        <div className="container">
          <p>Sistema desenvolvido pelo Curso de Análise e Desenvolvimento de Sistemas</p>
          <p><strong>Instituto Federal do Piauí - Campus Corrente</strong></p>
        </div>
      </footer>
    </div>
  );
