...
export function Login() {
  ...
  const validateField = (name: string, value: string) => {
    switch (name) {
      case 'matricula': {
        ...
        if (!matriculaRegex.test(value) && !emailRegex.test(value) && !usuarioRegex.test(value)) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError('Credenciais inválidas. Integração com API de autenticação pendente.');
            ...
            <Box component="form" onSubmit={handleSubmit} sx={{ width: '100%' }}>
              ...
              <Button
                ...
                sx={{
                  ...
                  borderRadius: '12px',
                  height: '56px',
                  background: 'linear-gradient(135deg, var(--verde-esperanca) 0%, var(--azul-confianca) 100%)',
                  '&:hover': {
                    background: 'linear-gradient(135deg, var(--azul-confianca) 0%, var(--verde-esperanca) 100%)',
                    transform: 'translateY(-2px)',
