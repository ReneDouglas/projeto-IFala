            ...
            <div className='action-buttons'>
              <div className='action-card'>
                <div className='action-card-icon'>
                  <span className='material-symbols-outlined notranslate' translate="no">shield</span>
                </div>
      ...
      <section className='security-section'>
        <div className='container'>
          ...
          <div className='security-features'>
            ...
            <div className='security-feature'>
              <div className='security-feature-icon'>
                <span className='material-symbols-outlined notranslate' translate="no">block</span>
              </div>
            ...
            <div className='security-feature'>
              <div className='security-feature-icon'>
                <span className='material-symbols-outlined notranslate' translate="no">encrypted</span>
              </div>
            ...
            <div className='security-feature'>
              <div className='security-feature-icon'>
                <span className='material-symbols-outlined notranslate' translate="no">smartphone</span>
              </div>
          ...
          <div className='warning-section'>
            <div className='warning-card'>
              <h3 className='warning-title'>
                <span className='material-symbols-outlined notranslate' translate="no">warning</span> Aviso
                Importante
              </h3>
