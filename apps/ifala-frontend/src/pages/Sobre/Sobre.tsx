...
export function Sobre() {
  ...
  useEffect(() => {
    ...
    const fetchProfessor = async () => {
      try {
        const response = await fetch('https://api.github.com/users/ReneDouglas');
        if (response.ok) {
  ...
  return (
    <>
        ...
        <div className='container'>
          ...
          <section className='sobre-section'>
            ...
            <div className='sobre-section-content'>
              ...
              <p>
                O <strong>IFala</strong> é um sistema de denúncias anônimas desenvolvido para
                proporcionar um canal seguro e confidencial onde estudantes do Instituto Federal
                do Piauí - Campus Corrente possam relatar ocorrências que acontecem dentro da
                instituição.
              </p>
              <p>
                O projeto foi desenvolvido como parte da disciplina de{' '}
                <strong>Programação para Internet II</strong> do curso de Análise e
                Desenvolvimento de Sistemas do IFPI, com o objetivo de criar uma solução real
                que atenda às necessidades da comunidade acadêmica.
              </p>
              <p>
                Nosso sistema garante <strong>anonimato total</strong>, não coletando ou
                armazenando dados pessoais dos usuários. Toda comunicação é protegida por
                criptografia avançada, e o acompanhamento das denúncias é feito através de
          ...
          <section className='sobre-section'>
            ...
            <div className='sobre-section-content'>
              <p>
                O IFala é um projeto de código aberto e estamos abertos a contribuições da
                comunidade. Se você deseja contribuir com o projeto, aqui estão algumas formas
                de fazer isso:
              </p>
              <div className='contribution-cards'>
                ...
                <div className='contribution-card'>
                  ...
                  <p>
                    Tem uma ideia para melhorar o sistema? Compartilhe suas sugestões através
                    das issues do projeto.
                  </p>
                </div>
                <div className='contribution-card'>
                  <span className='material-symbols-outlined notranslate' translate='no'>
          ...
          <section className='sobre-section agradecimentos-section'>
            ...
            <div className='sobre-section-content'>
              <div className='agradecimentos-card'>
                <p>
                  Agradecemos especialmente aos servidores do setor de TI do Campus Corrente:
                </p>
                ...
                <p>
                  Pela colaboração, suporte técnico e infraestrutura disponibilizada para o
                  desenvolvimento e hospedagem deste projeto.
                </p>
              </div>
            </div>
          </section>
      ...
      <footer className='footer'>
        <div className='container'>
          <p>
            Sistema desenvolvido por alunos do Curso de Análise e Desenvolvimento de Sistemas
          </p>
          <p>
