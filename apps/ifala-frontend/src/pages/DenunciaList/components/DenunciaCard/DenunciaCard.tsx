...
export const DenunciaCard = ({ denuncia, onViewDetails, onViewMessages }: DenunciaCardProps) => {
  ...
  return (
    <div className={`denuncia-card bg-white ${getPriorityColor(denuncia.status)}`}>
      {/* Header com token e status */}
      <div className="denuncia-header">
        <div className="header-left">
          <div className="denuncia-token">
            <span className="material-symbols-outlined token-icon">fingerprint</span>
      ...
      <div className="denuncia-content">
        ...
        {denuncia.hasUnreadMessages && (
          <div className="unread-messages-alert">
            ...
            >
              <span className="alert-icon material-symbols-outlined">mark_email_unread</span>
